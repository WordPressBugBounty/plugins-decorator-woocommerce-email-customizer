 ...
 *  
 *
 * @package  Wt_Decorator  
 */
if (!defined('ABSPATH')) {
    exit;
}
class Wt_Decorator_Review_Request
{
    /**
    * config options 
    */
    private $plugin_title="Decorator - WooCommerce Email Customizer";
    private $review_url="https://wordpress.org/support/plugin/decorator-woocommerce-email-customizer/reviews/#new-post";
    private $plugin_prefix="wt_decorator"; /* must be unique name */
    private $activation_hook="wt_decorator_activate"; /* hook for activation, to store activated date */
...
new Wt_Decorator_Review_Request();